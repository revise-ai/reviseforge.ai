    ...
    <main className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 pb-16">
        <div className="w-full max-w-[420px] flex flex-col items-center">
          ...
          {/* ── MODE: RESET PASSWORD (came from email link) ── */}
          {isResetMode ? (
            <>
            ...
            <>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-2xl px-4 py-3.5 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition mb-4"
              />
