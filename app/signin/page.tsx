      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 pb-16">
        <div className="w-full max-w-[420px] flex flex-col items-center">
          ...
          <div className="flex items-end gap-0.5 mb-8">
            ...
            <span className="w-3 h-4.5 bg-gray-900 rounded-sm" />
          ...
          {/* Sign in button */}
          <button className="w-full bg-gray-600 hover:bg-gray-700 text-white rounded-2xl py-3.5 text-sm font-semibold transition-all active:scale-[0.99] shadow-sm mb-6 cursor-pointer">
            Sign In
          </button>
