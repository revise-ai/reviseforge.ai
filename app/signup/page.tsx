...
function SignupInner() {
    ...
    try {
      ...
      if (error) {
        ...
        if (inviteCode) {
          ...
          showToast(
            "Account created! Check your email to confirm, then sign in — you'll be added to the channel automatically.",
            "success"
          );
          setTimeout(() => router.push(`/signin?invite=${inviteCode}`), 3000);
        } else {
  ...
  // Google signup — no confirmation email, goes straight to dashboard
        ...
        <div className="w-full max-w-[420px] flex flex-col items-center">
          ...
          <div className="relative w-full mb-2">
            <input
              ...
              onKeyDown={(e) => { if (e.key === "Enter") handleEmailSignup(e as any); }}
