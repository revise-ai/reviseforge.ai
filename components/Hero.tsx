    ...
    <section className="flex flex-col items-center bg-white">
      <nav className="flex flex-col items-center w-full">
        <div className="flex items-center justify-between p-4 md:px-16 lg:px-24 xl:px-32 md:py-4 w-full">
          ...
          >
            <a href="#" onClick={() => setMobileOpen(false)} className="text-[#050040] hover:text-[#050040]/70">Home</a>
            <a href="#" onClick={() => setMobileOpen(false)} className="text-[#050040] hover:text-[#050040]/70">Products</a>
            <a href="#" onClick={() => setMobileOpen(false)} className="text-[#050040] hover:text-[#050040]/70">Features</a>
            <a href="#" onClick={() => setMobileOpen(false)} className="text-[#050040] hover:text-[#050040]/70">Pricing</a>
            <a href="#" onClick={() => setMobileOpen(false)} className="text-[#050040] hover:text-[#050040]/70">Docs</a>
            <button
              id="close-menu"
      ...
      <p className="text-center text-base text-gray-500 max-w-md px-4">
        Turn your lectures, videos and notes into quizzes, flashcards and recordings — all in one place.
      </p>

      {/* CTA buttons */}
      <div className="flex items-center gap-4 mt-5 justify-center z-1">
        <Link href={"/signup"} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md cursor-pointer">
          Get Started For Free
        </Link>
        ...
        <div className="relative z-1 rounded-2xl overflow-hidden border border-gray-200 shadow-xl shadow-gray-100 bg-white">
          ...
          <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100 bg-gray-50">
            ...
            <div className="flex-1 mx-4 bg-gray-200 rounded-md h-5 flex items-center px-3">
              <span className="text-[10px] text-gray-400 truncate">app.yourstudy.ai/dashboard</span>
            </div>
          </div>
          ...
          <div className="flex h-[420px] bg-gray-50">
            ...
            <div className="w-56 bg-white border-r border-gray-100 flex flex-col p-4 gap-3 shrink-0">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-gray-800">StudyAI</span>
              </div>
              ...
              {/* Recent */}
              <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-wide mt-1">Recent</p>
              {["Introduction to Biology", "World History Ch. 4", "Calculus Notes"].map((item) => (
                <div key={item} className="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <svg width="12" height="12" fill="none" viewBox="0 0 24 24" stroke="#9CA3AF" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
              ...
              <div className="mt-auto border border-gray-100 rounded-xl p-3 bg-gray-50">
                ...
                <p className="text-xs font-semibold text-gray-700 mt-0.5">Free plan</p>
                <div className="flex items-center gap-1 mt-2">
                  <svg width="10" height="10" fill="none" viewBox="0 0 24 24" stroke="#374151" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                  <span className="text-[10px] text-gray-600">Upgrade plan</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 p-6 overflow-hidden">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <h3 className="text-base font-semibold text-gray-800">What would you like to study today?</h3>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                {[
                  ...
                  <div key={card.label} className="flex items-center gap-3 bg-gray-100 rounded-xl px-4 py-3 cursor-pointer hover:bg-gray-200 transition">
              ...
              <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-4 py-2.5 shadow-sm">
                <span className="text-xs text-gray-400 flex-1">Ask anything, or paste a YouTube link...</span>
                <div className="w-6 h-6 bg-gray-900 rounded-lg flex items-center justify-center shrink-0">
                  <svg width="10" height="10" fill="none" viewBox="0 0 24 24" stroke="white" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
                </div>
              </div>
            </div>
          </div>
