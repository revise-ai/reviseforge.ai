    ...
    <>
      ...
      <aside className="fixed left-0 top-0 bottom-0 w-22.5 bg-white border-r border-gray-200 flex flex-col z-40">
        ...
        <div className="flex-1 flex flex-col items-center gap-1 px-3">
          ...
          <div className="text-[10px] text-gray-400 font-medium mt-1 mb-0.5">
            Notes
          </div>
                ...
                <div className="space-y-0.5">
                  {channels.map((channel) => {
                    ...
                    return (
                      <div
                        key={channel.id}
                        className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors group cursor-pointer ${isActive ? "bg-blue-50 text-blue-700" : "hover:bg-gray-100 text-gray-700"}`}
                      >
                        <div className="w-2 h-2 rounded-full bg-green-500 shrink-0" />
                        <Link
                          href={`/dashboard/channel/${slug}`}
                          onClick={() => setShowChannelsPanel(false)}
